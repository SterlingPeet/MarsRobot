 ...
 * MarsRobot::TopologyState see: MarsRobotTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type MarsRobot::TopologyState see: MarsRobotTopologyDefs.hpp.
 *
