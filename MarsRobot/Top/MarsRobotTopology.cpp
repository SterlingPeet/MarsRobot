...
Svc::Health::PingEntry pingEntries[] = {
    {PingEntries::MarsRobot_blockDrv::WARN, PingEntries::MarsRobot_blockDrv::FATAL, "blockDrv"},
    {PingEntries::MarsRobot_tlmSend::WARN, PingEntries::MarsRobot_tlmSend::FATAL, "chanTlm"},
    {PingEntries::MarsRobot_cmdDisp::WARN, PingEntries::MarsRobot_cmdDisp::FATAL, "cmdDisp"},
    {PingEntries::MarsRobot_cmdSeq::WARN, PingEntries::MarsRobot_cmdSeq::FATAL, "cmdSeq"},
    {PingEntries::MarsRobot_eventLogger::WARN, PingEntries::MarsRobot_eventLogger::FATAL, "eventLogger"},
    {PingEntries::MarsRobot_fileDownlink::WARN, PingEntries::MarsRobot_fileDownlink::FATAL, "fileDownlink"},
    {PingEntries::MarsRobot_fileManager::WARN, PingEntries::MarsRobot_fileManager::FATAL, "fileManager"},
    {PingEntries::MarsRobot_fileUplink::WARN, PingEntries::MarsRobot_fileUplink::FATAL, "fileUplink"},
    {PingEntries::MarsRobot_prmDb::WARN, PingEntries::MarsRobot_prmDb::FATAL, "prmDb"},
    {PingEntries::MarsRobot_rateGroup1::WARN, PingEntries::MarsRobot_rateGroup1::FATAL, "rateGroup1"},
    {PingEntries::MarsRobot_rateGroup2::WARN, PingEntries::MarsRobot_rateGroup2::FATAL, "rateGroup2"},
    {PingEntries::MarsRobot_rateGroup3::WARN, PingEntries::MarsRobot_rateGroup3::FATAL, "rateGroup3"},
};
...
void configureTopology(const TopologyState& state) {
    ...
    // Note: Uncomment when using Svc:TlmPacketizer
    // tlmSend.setPacketList(MarsRobotPacketsPkts, MarsRobotPacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name MarsRobot
namespace MarsRobot {
